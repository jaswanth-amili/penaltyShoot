...
var UpdateGoals = () => {
  ...
  team1.goals.forEach((goals, index) => {
      goals === 0 ? teamOne[index].style.backgroundColor = "red" : teamOne[index].style.backgroundColor = "green";
    // teamOne[index].textContent = goals;
  });
  team2.goals.forEach((goals, index) => {
    goals === 0 ? teamTwo[index].style.backgroundColor = "red" : teamTwo[index].style.backgroundColor = "green";
  });
};
